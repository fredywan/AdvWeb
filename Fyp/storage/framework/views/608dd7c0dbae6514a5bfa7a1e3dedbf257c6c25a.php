          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-12">
                ...
                <input type=hidden name='id' value="<?php echo e($display['id']); ?>">
                <br><br/>

                <h1>Start Date: </h1>
                <input type=date name='start' value="<?php echo e($display['start']); ?>"><br><br/>

                <h1>End Date: </h1>
                <input type=date name='end' value="<?php echo e($display['end']); ?>"><br><br/>

                <h1>Duration (Month): </h1>
                <input type=int name='duration' value="<?php echo e($display['duration']); ?>"><br><br/>
...
</html><?php /**PATH C:\AdvWeb\fyp\resources\views/updProj.blade.php ENDPATH**/ ?>